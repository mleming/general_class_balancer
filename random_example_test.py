...
c1 = np.array([norm(1, 2, N/3),norm(0.5, 2, N/3),norm(2, 1, N/3)],dtype=object)
c2 = np.array([norm(3, 2, N/3),norm(0.5, 2, N/3),norm(3.1, 0.25, N/3)],dtype=object)
c3 = np.array([norm(2, 1, N/3),norm(0.5, 2, N/3),norm(2.9, 1, N/3)],dtype=object)
